...
function widokAdminProdukty(){
  ...
  return asortymentSzkielet("produkty", `
    <div class="assortment-catalog-workspace">
      ...
      <div class="assortment-table-wrap catalog-product-table-shell"><table class="log-table admin-responsive-table assortment-product-table density-${gestoscAdminProduktow}">
