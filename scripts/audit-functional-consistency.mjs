...
const allowedMaintenanceReloads = ['15d-publication-and-export.js', '16-diagnostics.js'];
const checks = [
  ...
  ['Pełne przeładowanie występuje tylko po resecie lub imporcie kopii', frontendReloads.length === allowedMaintenanceReloads.length && frontendReloads.every((name) => allowedMaintenanceReloads.includes(name))],
];
