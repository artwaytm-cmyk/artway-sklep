...
const content = [
  ...
  ...rows.flatMap(({ id, definition, model, fallback, platformProfile, prompt, details }) => [
    ...
    '',
    platformProfile ? `Przejściowa referencja legacy do zapisanego promptu: [${platformProfile.id}, wersja ${platformProfile.version}](${platformPromptUrl(platformProfile)}). Kanoniczna instrukcja znajduje się poniżej i w kodzie.` : 'Ta rola świadomie nie ma nowego obiektu promptu legacy w Platformie; obowiązuje wersja serwerowa poniżej.',
    '',
