...
export const ASSET_BUNDLES = Object.freeze([
  {
    output: 'assets/admin-boot.js',
    banner: '/* GENERATED ADMIN DIRECT-ENTRY BOOT — edit src/frontend/00-admin-direct-entry-boot.js */',
    sources: ['src/frontend/00-admin-direct-entry-boot.js'],
  },
  {
    ...
    sources: [
      ...
      'src/frontend/01c-site-release-preview.js',
      ...
      'src/frontend/06e-customer-publications.js',
  ...
  },
  {
    ...
    sources: [
      ...
      'src/frontend/08b-site-release-runtime.js',
      ...
      'src/frontend/12-product-editor-channel-readiness.js',
      ...
      'src/frontend/19a-product-link-file-import-fields.js',
      ...
      'src/frontend/15f-customer-publications.js',
      'src/frontend/15h-site-release-center.js',
      'src/frontend/15g-contest-center.js',
      'src/frontend/15g1-contest-center-advanced.js',
  ...
  {
    output: 'assets/site-release-preview.css',
    banner: '/* GENERATED SITE RELEASE PREVIEW — loaded only for signed preview/editor */',
    sources: ['src/styles/13-site-release-preview.css'],
  },
  {
    output: 'assets/customer-publications.css',
    banner: '/* GENERATED CUSTOMER PUBLICATIONS — loaded only for a verified promotional link */',
    sources: ['src/styles/11-customer-publications.css'],
  },
  {
    output: 'assets/store-contests.js',
    banner: '/* GENERATED STOREFRONT CONTESTS — loaded only on contest routes */',
    sources: ['src/frontend/06f-storefront-contests.js', 'src/frontend/06g-storefront-contests-advanced.js'],
  },
  {
    output: 'assets/store-contests.css',
    banner: '/* GENERATED STOREFRONT CONTEST STYLES — loaded only on contest routes */',
    sources: ['src/styles/12-storefront-contests.css'],
  },
  {
    ...
    sources: [
      ...
      'src/styles/39-customer-publications-admin.css',
      'src/styles/40-contest-center-admin.css',
      'src/styles/41-site-release-center.css',
    ],
  },
  {
  ...
  },
  {
    ...
    sources: ['src/styles/37-von-halsky-workspace.css', 'src/styles/37a-von-halsky-picking.css'],
  },
]);
...
export const ADMIN_RUNTIME_BUNDLES = Object.freeze([
  ...
  {
    output: 'assets/admin-contests.js',
    banner: '/* GENERATED ADMIN CONTESTS — loaded only for the contest center */',
    sources: ['src/frontend/15g-contest-center.js', 'src/frontend/15g1-contest-center-advanced.js'],
  },
  {
