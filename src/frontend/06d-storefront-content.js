...
function widokDostawa(){
  ...
  return stronaInfo("🚚 Dostawa i płatności", `
    ...
    <p>Płatności online przez Paynow obsługuje mElements S.A., a płatności kartami w tej usłudze obsługuje Autopay S.A. Metoda pojawi się w checkout dopiero po zakończeniu konfiguracji i pozytywnym połączeniu bramki. Dla płatności online realizację rozpoczynamy po pozytywnej autoryzacji.</p>
    <p><b>InPost Pay może działać równolegle z Paynow</b> jako dodatkowy, ekspresowy proces zakupu łączący płatność i dostawę w aplikacji InPost. Pojawi się dopiero po zawarciu oddzielnej umowy InPost Pay, wdrożeniu otrzymanej dokumentacji i pozytywnych testach integracyjnych — istniejący token ShipX do etykiet nie aktywuje InPost Pay.</p>
    <h2>Kody rabatowe</h2>
