...
test('adres niedostępnego produktu pozostaje aktywny, ale sitemap nie proponuje go do indeksowania', async () => {
  ...
  assert.match(seoCatalog, /indexableProducts = pageProducts\.filter/);
