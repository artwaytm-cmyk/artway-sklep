...
test('import oraz korekta Agenta używają wyłącznie trwałej pracy serwerowej', async () => {
  ...
  assert.match(agentBody, /allegro-preparation-queue-auto/);
  assert.match(agentBody, /storage:"postgresql"/);
