...
test('trasy panelu ładują jawnie moduły wymagane przez swoje widoki', async () => {
  ...
  assert.match(router, /t==="\/diagnostyka"\|\|t==="\/admin\/system\/diagnostyka"\)add\("agent","warehouse","shipping","commerce","communications","inventory","catalog","personalization","system","vonHalsky"\)/);
