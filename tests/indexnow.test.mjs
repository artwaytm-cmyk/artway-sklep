...
import { INDEXNOW_CATALOG_VERSION, INDEXNOW_KEY, INDEXNOW_KEY_LOCATION, eligiblePromotionProducts, normalizeIndexNowUrls, runIndexNowPromotion, submitIndexNow } from '../src/backend/lib/domain/indexnow.mjs';
...
test('pierwsze uruchomienie IndexNow zgłasza cały katalog, a kolejne tylko zmiany', async () => {
  ...
  const next = await runIndexNowPromotion({ catalogProducts: [{ id: 1 }, { id: 2 }], changedProducts: [{ id: 2 }], config: { indexNowEnabled: true, indexNowFullCatalogAt: '2026-07-15T00:00:00.000Z', indexNowCatalogVersion: INDEXNOW_CATALOG_VERSION }, fetchImpl });
