...
test("panel zapamiętuje ostatnie podstrony i ma kontrolowany powrót bez zapętlenia",async()=>{
  const router=await read("assets/app.js"),history=await read("src/frontend/08a-admin-responsive-layout.js"),shell=await read("assets/admin-shell.js"),styles=await read("src/styles/29-commerce-catalog-actions.css");
